...
def main():
    ...
    parser.add_argument('--stack_modelpath', type=str, default='models/saved_models/best_stacked_model_refined.pth', help="GAN model filepath")
    ...
    gan_model = load_stacked_model(args.stack_modelpath)
