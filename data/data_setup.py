...
lowResImagesPath = Path("raw/cctv_footage/surveillance_cameras_all")
lowResImages = list(lowResImagesPath.glob("*.jpg"))  # 2860

highResImagesPath = Path("raw/high_quality_images/mugshot_frontal_original_all")
...
def copy_image(src, dest):
    ...
    for idx, img in enumerate(src):
        dest_img_path = dest / (img.stem.split('_')[0] + "_" + "".join(img.stem.split('_')[1:]) + ".jpg")
